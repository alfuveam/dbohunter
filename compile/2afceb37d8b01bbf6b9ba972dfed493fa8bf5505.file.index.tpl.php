<?php /* Smarty version 3.0rc1, created on 2017-02-26 21:56:02
         compiled from "templates/NQO-By Mateushurley\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:874658b340e2e09c15-37135109%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2afceb37d8b01bbf6b9ba972dfed493fa8bf5505' => 
    array (
      0 => 'templates/NQO-By Mateushurley\\index.tpl',
      1 => 1426683006,
    ),
  ),
  'nocache_hash' => '874658b340e2e09c15-37135109',
  'function' => 
  array (
  ),
...
/templates/NQO-By Mateushurley/main.css" />
		<link href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
/templates/NQO-By Mateushurley/favicon.ico" rel="shortcut icon" />
	</head>
	<!--Google-->
...
/index.php/account/">Minha Conta</a></li>
							<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
/index.php//p/v/pagseguro">Donate</a></li>
							<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
/index.php/p/v/gifts/">Shop</a></li>
							<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
/index.php/p/v/chars">Venda de Chars</a></li>
							<?php }else{ ?>
							<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
...
/index.php/character/online">Online</a></li>
					...
					<ul>
				          	<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
/index.php/p/v/guia">Guia</a></li>
				        	<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
/index.php/p/v/faq">FAQ</a></li>
				        	<li><a href="<?php echo $_smarty_tpl->getVariable('path')->value;?>
					...
					<div class="top">
						<div class="bot">
							<div id="vt_panel_buttons">
								<a href="http://www.mediafire.com/download/5g3p13t13p4oj0x/Hunter+Games+Instalador.exe" class="button">
									 <span></span>
								</a>
...
/templates/NQO-By Mateushurley/images/authornote.fw.png" alt="Designed by Mateushurley" /></a>
				</div>
				<div class="column second">
					<p>2014- NTOWhite			<p><small>Page rendered in: <?php echo $_smarty_tpl->getVariable('renderTime')->value;?>
