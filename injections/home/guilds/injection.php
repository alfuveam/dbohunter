...
$SQL = $ots->getDBHandle();
echo'	<div class="message"><div class="title">Guilds Mais Poderosas</div>	<div class="content">
...
echo'	</tr>
	...
	if(empty($is)) {
		echo "<center><font color='red'>Não há guilds no servidor ainda.</font></center>";
	}
echo "</div>";
echo "</div>";
?>
