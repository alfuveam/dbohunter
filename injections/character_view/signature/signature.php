<?PHP
	...
	// Player Sex
	$MadGD->addText( 'Gender:', $MadGD->textBold )->setPosition( 10, $row * $height );
	$MadGD->addText( $character->getSex( ) == 1 ? 'Masculino' : 'Feminino' )->setPosition( ); $row++;
	// Player Profession
	$MadGD->addText( 'Vocation:', $MadGD->textBold )->setPosition( 10, $row * $height );
	...
	{
		$MadGD->addText( 'Guild:', $MadGD->textBold )->setPosition( 10, $row * $height );
	...
	// Account Status
	$MadGD->addText( 'Status Account:', $MadGD->textBold )->setPosition( 10, $row * $height );
