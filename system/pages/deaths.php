<?php
	...
	echo "<div style=\"text-align: center; font-weight: bold;\">Últimas Mortes</div><table border=\"0\" cellspacing=\"1\" cellpadding=\"4\" width=\"100%\">";
	echo "&nbsp;";
	if($deaths->rowCount())
	{
		...
		echo "<tr class=\"highlight\"><td style=\"text-align: center;\">Ninguém morreu ultimamente.</td></tr>";
