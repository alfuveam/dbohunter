	...
	if(!$ide->isLogged())
		...
		if(count($characters) == 0)
			...
			echo form_open(WEBSITE."/index.php/home/view/".$id);
				echo "<br/><label>&nbsp;Personagem:</label><br/><br/>";
				echo "<select name='character'>";
					foreach($characters as $character) {
						echo "<option value='".$character['id']."'>".$character['name']."</option>";
					}
				echo "</select><br/><br/>";
				echo "<label>&nbsp;Captcha:</label><br/><br/>";
				echo $captcha;
				echo "<br/><br/><input size='17' type='text' name='captcha'/><br/>";
				echo "<br/><label>&nbsp;Comentário:</label><br/><br/>";
				echo "<textarea style='width: 99%;' name='body'>".@$_POST['body']."</textarea><br/><br/>";
