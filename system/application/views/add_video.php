<?php 
	echo "<center><b>Adicione aqui seus vídeos. Use links de vídeos do <a href='http://youtube.com' target='_blank'>YouTube</a>.</b></center><br/>";
	...
	echo form_open("video/add");
		...
		echo "<button class='btn btn-success' type='submit'>Adicionar Vídeo</button>";
	echo "</form>";
