...
<div style='border: 1px solid silver; padding: 5px;'>
	<b>Adicionado por: </b> <a href='<?php echo WEBSITE; ?>/index.php/character/view/<?php echo $video[0]['author']; ?>'><?php echo $video[0]['author'];?></a>
	&nbsp; &nbsp; &nbsp; <b>Data: </b> <?php echo ago($video[0]['time']); ?>
	&nbsp; &nbsp; &nbsp; <b>Vizualizações</b> <?php echo $video[0]['views']; ?>
	<br/>
