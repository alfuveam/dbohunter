...
echo "<div class='title'>Criar Guild</div>";
	if(count($characters) == 0) 
		error("Nenhum dos seus personagens tem o level requerido para criar uma guild. (<b>".$config['levelToCreateGuild']."</b>)");
	else {
	...
	echo "<button class='btn btn-info' type='submit' name='submit'>Criar Guild</button>";
	echo "</form>";
